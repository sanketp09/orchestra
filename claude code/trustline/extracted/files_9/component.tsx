...
function EmbossedCard({
  ...
  return (
    <Card
      className={cn("rounded-[12px] border border-white/5 bg-[var(--surface-card)] p-4", className)}
      style={{
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        selected
          ? "border-none bg-[var(--accent)] text-white font-bold"
          : "border-white/10 bg-[var(--surface-card)] text-white/70 hover:bg-white/5"
      )}
    >
      {label}
    </motion.button>
...
export default function SupplierCapabilityGraph() {
  ...
  return (
    <div className="w-full p-6 font-[Inter,sans-serif] md:p-10" style={{ ...THEME_VARS }}>
