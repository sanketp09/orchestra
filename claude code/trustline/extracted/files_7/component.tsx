      ...
      {nodes.map((n, i) => (
        ...
        >
          <circle
            ...
            cy={n.y}
            r={n.connected ? 52 : 44}
            fill={n.connected ? "color-mix(in srgb, var(--ai) 12%, var(--surface-floating))" : "var(--surface-card)"}
            stroke={n.connected ? "var(--ai)" : "var(--muted)"}
        ...
        {screen === "results" && (
          <motion.div key="results" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col gap-6">
            ...
            <motion.div
              ...
              style={{
                background: "color-mix(in srgb, var(--surface-floating) 72%, transparent)",
                border: "1px solid color-mix(in srgb, var(--surface-floating) 60%, transparent)",
                backdropFilter: "blur(12px)",
                WebkitBackdropFilter: "blur(12px)",
                boxShadow: "0 8px 24px rgba(12,9,4,.10)",
              }}
            >
