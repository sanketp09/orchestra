...
export default function RippleCheck() {
  const [decisionId, setDecisionId] = useState<string>(DECISION_OPTIONS[0].id);
  const [data, setData] = useState<RippleCheckResponse>(FALLBACK_DATA[DECISION_OPTIONS[0].id]);
